...
<section id="list_cards" class="mt-4 d-none row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-xl-4 g-4 justify-content-center">
...
<section id="no_products" class="container d-none bg-danger text-white justify-content-center rounded p-3 mt-4">
    Aucun produit disponible actuellement dans la boutique. Merci de réessayer plus tard.
</section>
