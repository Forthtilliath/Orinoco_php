...
<h1 class="text-center page-title">Orinoco<span class="d-none d-xss-block"> - Affichage du panier</span></h1>
...
<section class="container" id="list_cards">
    <?php for ($i = 0; $i < 1; $i++) : ?>
        <exp-article class="row mb-3 g-md-1" id="card_0">
            ...
            <div class="col-md-9 col-lg bg-tertiary p-md-3 border-md border-quinary">
                <div class="card-body">
            ...
            <div class="col-6 col-md-4 col-lg-2 bg-tertiary p-md-3 border-md border-quinary">
                <div class="card-body d-flex flex-column h-100 justify-content-center align-items-center">
                    <p class="card-text text-right">Prix unitaire</p>
                    <div id="card_0_price" class="badge bg-primary text-wrap" style="width: 6rem;font-size:1em">1 657 €</div>
                </div>
            </div>
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 bg-tertiary p-md-3 border-md border-quinary text-center">
                <div class="d-flex flex-column h-100 justify-content-center">
                    <div class="form-floating">
                        <select is="exp-select" class="bg-denary form-select text-primary" id="card_0_quantity"></select>
                        <label class="text-primary" for="card_0_quantity">Quantité</label>
                    </div>
                    <div><button class="btn btn-danger w-auto w-md-100 px-3 mt-2" id="card_0_remove"><i class="bi bi-trash pe-3 d-none d-sm-inline"></i><span>Supprimer</span></button></div>
                </div>
            </div>
            <div class="col-md-4 col-lg-2 bg-tertiary p-md-3 border-md border-quinary">
                <div class="card-body text-center">
                    <p class="card-text text-right">Sous-total</p>
...
<section class="container d-none">
    <div class="row mb-3 g-1">
        ...
        <div class="col-4 bg-tertiary p-3 border border-quinary text-center">
            <div class="card-body text-center">
                <p class="card-text text-right fs-5" aria-l>Nombre d'articles</p>
                <div id="cards_nbarticles" class="badge bg-secondary text-wrap fs-5" style="width: 6rem">15</div>
            </div>
        </div>
        <div class="col-2 bg-tertiary p-3 border border-quinary text-center">
            <div class="card-body text-center">
                <p class="card-text text-right fs-5">Total</p>
